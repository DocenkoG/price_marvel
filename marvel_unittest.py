...
class Marvel(unittest.TestCase):
    def setUp(self):
	ffprofile = webdriver.FirefoxProfile()
        ...
        self.base_url = "https://b2b.marvel.ru/"
        self.verificationErrors = []
        self.accept_next_alert = True
    
    def test_marvel(self):
        driver = self.driver
        driver.get(self.base_url + "/Account/Login?ReturnUrl=%2f")
        driver.find_element_by_id("UserName").clear()
        driver.find_element_by_id("UserName").send_keys("avprom03")
        driver.find_element_by_id("Password").clear()
        driver.find_element_by_id("Password").send_keys("Mvzz5F_GVx")
